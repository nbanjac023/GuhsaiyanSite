...
@section('dashboard.content')
    <h1 class="dashboard__content-title">Porudžbina: {{ $order->id }}</h1>
    <div class="openable u-margin-bottom-sm @if($order->isArrived()) openable--success @else openable--false @endif">
            <div class="openable__closed" id="openable_closed">
                <h3 class="openable__title">Porudžbina: #{{ $order->id }}</h3>
